...
const QString BITCOIN_IPC_PREFIX("fef:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click fef: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start fef: click-to-pay handler");
    else
...
{
    // clicking on fef: URLs creates FileOpen events on the Mac:
